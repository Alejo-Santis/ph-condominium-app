...
<svelte:head>
    <title>Nueva persona — Portal PH</title>
</svelte:head>
...
<AppLayout>
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-semibold text-slate-900">Nueva persona</h1>
            <p class="text-sm text-slate-500 mt-0.5">Registra un propietario o arrendatario</p>
        </div>
    </div>
            ...
            <div class="px-6 py-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <TextInput id="document_number" bind:value={$form.document_number} placeholder="1234567890" error={$form.errors.document_number} />
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-5">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <TextInput id="email" type="email" bind:value={$form.email} placeholder="correo@ejemplo.com" error={$form.errors.email} />
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="phone" class="block text-sm font-medium text-slate-700 mb-1.5">Teléfono</label>
                            <TextInput id="phone" bind:value={$form.phone} placeholder="+57 300 000 0000" error={$form.errors.phone} />
                        </div>
                        <div>
